 ...
 */
@Path("/")
public class EnvironmentWallboardConfigResource {

    private static final Logger log = Logger.getLogger(EnvironmentWallboardConfigResource.class);

    private final UserManager userManager;
    private final PluginSettingsFactory pluginSettingsFactory;
    private final TransactionTemplate transactionTemplate;

    public EnvironmentWallboardConfigResource(UserManager userManager,
